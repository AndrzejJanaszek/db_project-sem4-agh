...
const RegisterUser = () => {
  ...
  // TODO: dodać walidację danych na frontendzie
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost:5000/api/register/user", {  // adres endpointu API dostosuj do swojego
        method: "POST",
        headers: {
      ...
      <form onSubmit={handleSubmit} className={style.loginForm}>
        <div className={style.registerSideDivider}>
          <section>
            ...
            <label className={style.loginFormLabel}>
              <p>powtórz hasło</p>
              <input type="password" name="secPassword" value={formData.secPassword} onChange={handleChange} />
            </label>
          </section>
